...
function clickButton(type) {
    if (type === 'clicker') {
        ...
        alert('В новой версии я полностью обновил дизайн страницы, а именно изменил стиль всех кнопок, поменял задний фон и добавил ему размытие, привязку к экрану и затемнение, добавил фото Блока Травы из Майнкрафт на кликер, чтобы улучшить визуал. У сайта наконец появился логотип, который вы можете наблюдать вверху страницы, а также иконка, которую. вы можете увидеть с ПК - слева от названия вкладки браузера, на Android/IOS при просмотре всех вкладок. Появилась ссылка на донат "buy me a coffee" и эта кнопка. Полностью изменился шрифт основных текстов.');
    }
}
